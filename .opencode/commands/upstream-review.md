...
Return concrete blockers and a proposed clean commit range. This command uses the
writable primary because fetching and Git inspection are forbidden to children.
