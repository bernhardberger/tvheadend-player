...
non-substitutable gates. Never source the guard or credentials or use fixtures.
For non-trivial non-UX work retain the independent Astra first review on the same
bounded evidence, not the implementing primary's self-review.
