...
# TVHeadend Player locally added live-test credential isolation; see ../SKILL.md.
...
LIVE_TEST_OPT_IN = "GRADLE_RUN_ALLOW_LIVE_TESTS"
LIVE_TEST_CREDENTIAL_ENV = (
    "TVHEADEND_SOAK_CREDENTIALS_FILE",
    "TVHEADEND_SOAK_NODVR_CREDENTIALS_FILE",
)
...
def command_environment() -> dict[str, str]:
    ...
    if environment.get(LIVE_TEST_OPT_IN) != "1":
        for name in LIVE_TEST_CREDENTIAL_ENV:
