...
internal data class RecordingProgressWrite(
    val positionSeconds: Long,
    val setWatched: Boolean,
)

internal fun interface RecordingProgressWriter {
...
internal data class RecordingProgressSnapshot(
...
internal class RecordingProgressCoordinator(
