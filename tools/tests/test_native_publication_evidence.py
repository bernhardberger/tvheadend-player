...
class NativePublicationEvidenceTest(unittest.TestCase):
    def test_public_release_bytes_and_corresponding_sources_are_pinned(self) -> None:
        self.assertEqual(CHECKER["SDK_COORDINATE"], "at.bernhardberger.tvheadend:sdk-media3:0.19.0")
        self.assertEqual(
            CHECKER["EXPECTED_AAR_SHA256"],
            "2bcbc7c289be366f54be578a3487a0b0ef100ca8814cbfa784327cfab7b93450",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            {
                "sdk-android-0.19.0-sources.jar":
                    "5361e2924b04e6779dbb752a1cbeb2c72d4c6d8075319265682ba9af09872991",
                "sdk-core-0.19.0-sources.jar":
                    "fb81cdd52cef0885fbcfe377abeacc363dd23b6c9813c8cd558aa85dec284c1a",
                "sdk-media3-0.19.0-sources.jar":
                    "88a010f2e34086a100af5c6a0fc24a6eb28ae210c0a67c5fe720b94ff83e326e",
                "sdk-playback-0.19.0-sources.jar":
