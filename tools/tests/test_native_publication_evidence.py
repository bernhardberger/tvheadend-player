...
class NativePublicationEvidenceTest(unittest.TestCase):
    def test_public_release_bytes_and_corresponding_sources_are_pinned(self) -> None:
        self.assertEqual(CHECKER["SDK_COORDINATE"], "at.bernhardberger.tvheadend:sdk-media3:0.20.0")
        self.assertEqual(
            CHECKER["EXPECTED_AAR_SHA256"],
            "dd6cdcdf53c25f2314f40ab3c5f6a75352d805a95a0cfc91e86b0ad695aa1000",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            {
                "sdk-android-0.20.0-sources.jar":
                    "5361e2924b04e6779dbb752a1cbeb2c72d4c6d8075319265682ba9af09872991",
                "sdk-core-0.20.0-sources.jar":
                    "fb81cdd52cef0885fbcfe377abeacc363dd23b6c9813c8cd558aa85dec284c1a",
                "sdk-media3-0.20.0-sources.jar":
                    "5255a1dddd421da1c443cc033a116aecb4270241121cbe5c149b350414162097",
                "sdk-playback-0.20.0-sources.jar":
